...
- **10 optimally sited facilities** would bring **399,723** underserved Texans
...
```
scripts/     00–09 pipeline + paths.py + reorganize_data.py
...
- **US Census Bureau** — TIGER/Line 2024, 2020 Decennial population, 2020 Centers
  of Population, ZCTA Gazetteer. Public domain.
...
pyosmium 4.3, rapidfuzz, pyproj 3.6, matplotlib 3.10, python-docx.
